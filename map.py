...
# m.drawcountries()
# m.drawstates()
# m.readshapefile('/home/cauboi/linda/desafio-indicium/gadm41_USA_1', 'states', drawbounds=True)
m.readshapefile('/home/cauboi/linda/desafio-indicium/nyzones','mapa', drawbounds=True)
